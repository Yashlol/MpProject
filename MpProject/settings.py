...
SECRET_KEY = 'django-insecure-+aom_@uvfb(cog&$(kh7b&)3xylz=g03iq9pmr+csx##e9jvs5'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'lol', 'templates'), 
                 os.path.join(BASE_DIR, 'AgriOptimizer', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# https://docs.djangoproject.com/en/5.1/howto/static-files/
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR,'AgriOptimizer', 'static')]
#STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
